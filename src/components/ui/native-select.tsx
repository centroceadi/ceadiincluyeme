...
/**
 * <select> nativo (no el Select de shadcn/Base UI) — a propósito, para
 * garantizar que participe en FormData de forms sin JS que se mandan a
 * Server Actions. Mismo look que <Input>.
 */
